...
function getFromStorage(key) {
    const glidali = JSON.parse(sessionStorage.getItem('glidali'))
    if (glidali) {
        return glidali[key];
    }
    return null;
...
function initEvents() {
    ...
    let userFullName = getFromStorage('userFullName');
    if (userEmail && userFullName) {
        document.getElementsByName('name')[0].value = userFullName;
...
function loadShoppingCartItemsByUser() {
    ...
    if (params.has('userID')) {
        ...
        sessionStorage.setItem('glidali', JSON.stringify({ userID: userID, userEmail: params.get('userEmail'), userFullName: params.get('userFullName') }));
    } else {
    ...
    for (var i = 0; i < 8; i++) {
        ...
        <div class="product-info">
          ...
          <div class="product-info">
              ...
              <h2 class="product-price-Halfkg">2.00$ - 30ML</h2>
                  <p class="product-quantity-Halfkg">Qnt: <input class="product-quantity-Halfkg-input" type="number" min="1" id="${i + 'Halfkg'}"  onclick="UpdateCart(true,this,'Halfkg',${i})">
                  <h2 class="product-price-1kg">3.00$ - 50ML</h2>
                  <p class="product-quantity-1kg">Qnt: <input class="product-quantity-1kg-input" type="number" min="1" id="${i + 'Onekg'}"  onclick="UpdateCart(true,this,'Onekg',${i})">
          ...
          <div class="product-info">
              ...
              <h2 class="product-price-Halfkg">1.00$ - 20GR</h2>
                  <p class="product-quantity-Halfkg">Qnt: <input class="product-quantity-Halfkg-input" type="number" min="1" id="${i + 'Halfkg'}"  onclick="UpdateCart(true,this,'Halfkg',${i})">
                  <h2 class="product-price-1kg">2.00$ - 50GR</h2>
                  <p class="product-quantity-1kg">Qnt: <input class="product-quantity-1kg-input" type="number" min="1" id="${i + 'Onekg'}"  onclick="UpdateCart(true,this,'Onekg',${i})">
          ...
          <div class="product-info">
              <h3 class="product-name">White</h3>
                  <h2 class="product-price-Halfkg">2.00$ - 30GR</h2>
                  <p class="product-quantity-Halfkg">Qnt: <input class="product-quantity-Halfkg-input" type="number" min="1" id="${i + 'Halfkg'}"  onclick="UpdateCart(true,this,'Halfkg',${i})">
                  <h2 class="product-price-1kg">3.00$ - 50GR</h2>
                  <p class="product-quantity-1kg">Qnt: <input class="product-quantity-1kg-input" type="number" min="1" id="${i + 'Onekg'}"  onclick="UpdateCart(true,this,'Onekg',${i})">
                  <div class="product-remove">
                      <i class="fa fa-trash" aria-hidden="true"></i>
                      <button class="remove" onclick=RemoveBTM()>Remove</button>
...
if (document.location.pathname.includes('Events')) {
    ...
    if (params.has('success')) {
        alert("Event has been successfuly created!");
    }
}
...
if (document.location.pathname.includes('Payment')) {
    initCheckout();
}
